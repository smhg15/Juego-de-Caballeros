...
function Tactic11({players}) {
    ...
    return (
        <div className="field">
            ...
            <div className="box"><Pechera player={players[8]} number={7}/><Pechera player={players[9]} number={9}/><Pechera player={players[10]} number={11}/></div>
        </div>
    )

}
export default Tactic11;